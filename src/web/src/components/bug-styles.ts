...
export const STATUS_DOT_STYLES: Record<Bug["status"], string> = {
	open: "bg-rose-500",
...
export const PRIORITY_DOT_STYLES: Record<Bug["priority"], string> = {
	low: "bg-emerald-500",
	medium: "bg-sky-500",
	high: "bg-amber-500",
...
export const SOURCE_DOT_STYLES: Record<Bug["source"], string> = {
	arm_reported: "bg-blue-500",
	human_reported: "bg-violet-500",
	system_detected: "bg-rose-500",
};
